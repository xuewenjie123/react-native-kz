...
var List = [
  { code: "GD13742", name: "管辖", level: "无效", image: "70a1", image2: "36b1", phone: "1192293921", post: "", time: "2016-12-03 12:32", adress: "幸福家园小区 2号楼-1单元-1201室", status: "处理中",
    imgList: ["zelse72a1","zelse72a1"], opration: "[管道-水管破裂]房顶漏水，墙皮脱落！", },
  { code: "GD13742", name: "管辖", level: "一般", image: "70a2", image2: "36b2", phone: "1192293921", post: "", time: "2016-12-03 12:32", adress: "科筑物业", status: "处理中",
    opration: "[管道-水管破裂]房顶漏水，墙皮脱落！水龙头坏了，滴水很严重，麻烦房顶漏水，墙皮脱落！水龙头坏了，滴水很严重，麻烦……", },
  { code: "GD13742", name: "管辖", level: "重要", image: "70a3", image2: "36b1", phone: "1192293921", post: "", time: "2016-12-03 12:32", adress: "幸福家园小区 2号楼-1单元-1201室", status: "处理中",
    opration: "[管道-水管破裂]房顶漏水，墙皮脱落！", },
  { code: "GD13742", name: "管辖", level: "重大", image: "70a3", image2: "36b1", phone: "1192293921", post: "", time: "2016-12-03 12:32", adress: "幸福家园小区 2号楼-1单元-1201室", status: "处理中",
    opration: "[管道-水管破裂]房顶漏水，墙皮脱落！", },
  { code: "GD13742", name: "管辖", level: "无效", image: "70a3", image2: "36b1", phone: "1192293921", post: "", time: "2016-12-03 12:32", adress: "幸福家园小区 2号楼-1单元-1201室", status: "处理中",
    opration: "[管道-水管破裂]房顶漏水，墙皮脱落！", },
]
...
class ComplaintDealList extends Component {
  constructor(props) {
    super(props);
    this.state = {
      List: [],
  ...
  render() {
    var switchcolor = (swit) => {
      switch (swit) {
        case "无效":
          return color.black5C
          break;
        case "一般":
          return color.auxiliary2C
          break;
        case "重要":
          return color.auxiliary1C
          break;
        case "重大":
          return color.embe1C
          break;
        ...
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center',}}>
          <View style={{ borderWidth:1,borderStyle: 'solid', height: 32, width: 150,
            ...
            <TouchableOpacity  style={{flex: 1, alignItems: 'center', justifyContent: 'center',}}
              onPress={() => {this._onPushRouter("SugesstionDealList")}}>
        ...
        <View style={styles.main}>
          ...
          <ScrollView contentContainerStyle={styles.contentContainer}>
            <View style={styles.scrollbox}>
              {List.map((d,index)=>{
                var cont = (
                  <TouchableOpacity onPress={()=>{this._onPushRouter("ComplaintDealDetail")}}>
                    ...
                    <View style={styles.dabox4}>
                      <View style={[styles.dabox1,styles.dabox8]}>
                        <View style={{justifyContent: 'center',}}>
                          <View style={{marginRight: 10, height: 14, width: 39,
                            justifyContent: 'center', alignItems: 'center', backgroundColor: switchcolor(d.level)}}>
                            <Text style={styles.perdtit6}>
                              {d.level}
                            </Text>
                          </View>
                        </View>
...
module.exports = ComplaintDealList
