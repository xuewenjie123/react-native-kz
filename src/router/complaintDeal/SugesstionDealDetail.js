...
var { getSugesstionDatile, } = require('../../service/complaintDeal');
...
class SugesstionDealDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {
      obj: {},
...
module.exports = SugesstionDealDetail
