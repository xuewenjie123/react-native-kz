...
class ViewWorkListInquiries extends Component {
  constructor(props) {
    super(props);
                    ...
                    <View style={styles.dabox4}>
                      <View style={[styles.dabox1,styles.dabox8]}>
                        <View style={{justifyContent: 'center',}}>
                          <Image style={styles.image2} source={imageList[d.image2]}></Image>
                        </View>
                        <View style={styles.dabox2}>
                          <View style={{justifyContent: 'center',}}>
                            <Text style={styles.perdtit}>
...
module.exports = ViewWorkListInquiries
