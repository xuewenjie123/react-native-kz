...
class WorkOrderNeedDo extends Component {
  ...
  componentDidMount(){
    ...
    _this.setState({userId: _this.props.userId,});
    getNoAssignWorkOrder({currentUserId:_this.props.userId,currentPage: 1,pageSize: 10,},_this.updata);
  }
  updata(result){
