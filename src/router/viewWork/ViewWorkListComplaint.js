...
var { getList, } = require('../../service/viewWork');
...
class ViewWorkListComplaint extends Component {
  constructor(props) {
    super(props);
        ...
        <View style={styles.main}>
          ...
          <ScrollView contentContainerStyle={styles.contentContainer}>
            <View style={styles.scrollbox}>
              {List.map((d,index)=>{
                var cont = (
                  <TouchableOpacity onPress={this._onPushRouter.bind(this)}>
...
module.exports = ViewWorkListComplaint
